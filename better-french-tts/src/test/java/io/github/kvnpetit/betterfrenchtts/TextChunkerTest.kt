...
class TextChunkerTest {
    @Test
    fun emptyAndBoundaryInputsArePreserved() {
    ...
    @Test
    fun paragraphWinsOverLaterWordBoundary() {
    ...
    @Test
    fun sentenceAndClauseBoundariesKeepPunctuation() {
    ...
    @Test
    fun hardCutsPreserveSupplementaryUnicodeCharacters() {
