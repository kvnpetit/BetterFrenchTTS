 ...
 *
 * The [SpeechBuilder] provides a type-safe, readable API to build complex speech sequences with
 * pauses, prosody changes, emphasis, spell-out, say-as interpretations, and structural elements
