 ...
 *
 * Nodes are constructed by [io.github.kvnpetit.betterfrenchtts.dsl.SpeechBuilder] and rendered to
 * an XML string by [SsmlRenderer].
 *
 * This is an internal representation — library consumers interact with the DSL and never need to
 * create [SsmlNode] instances directly.
 *
...
sealed class SsmlNode {
     ...
     *
     * @property interpretAs The SSML interpretation type (e.g. `"cardinal"`, `"ordinal"`, `"date"`,
     ...
     */
    data class SayAs(val interpretAs: String, val content: String, val format: String? = null) :
        SsmlNode()
