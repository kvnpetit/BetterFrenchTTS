 ...
 *
 * The library ships with 12 built-in presets accessible via the companion object.
 * Custom presets can be created freely:
 * ```kotlin
 ...
 * @property rate SSML rate value: `"x-slow"`, `"slow"`, `"medium"`, `"fast"`, `"x-fast"`, or a percentage (`"85%"`).
 * @property pitch SSML pitch value in semitones relative to default (e.g. `"+2st"`, `"-1st"`, `"+0st"`).
 * @property volume SSML volume value: `"x-soft"`, `"soft"`, `"medium"`, `"loud"`, or `"x-loud"`.
 * @see BetterFrenchTts.speak
 * @see com.github.kvnpetit.betterfrenchtts.dsl.SpeechBuilder.withPreset
 */
